...
{
    internal class P9_召唤_SC : SplatoonScript
    {
        public override HashSet<uint> ValidTerritories => new() { 1148 };
        public override Metadata? Metadata => new(3, nameof(P9_召唤_SC));
        ...
        public override void OnMessage(string Message)
        {
            ...
            if (Message.Contains("距离战斗开始还有10秒！"))
            {
                ...
                P4_Time = Environment.TickCount64 + 60 * 4 * 1000 + 20 * 1000;
                P5_Time = Environment.TickCount64 + 60 * 5 * 1000 + 20 * 1000;
                P6_Time = Environment.TickCount64 + 60 * 6 * 1000 + 20 * 1000;
                P7_Time = Environment.TickCount64 + 60 * 7 * 1000 + 20 * 1000;
                P8_Time = Environment.TickCount64 + 60 * 8 * 1000 + 20 * 1000;
                P9_Time = Environment.TickCount64 + 60 * 9 * 1000 + 20 * 1000;
            }
        }
        ...
        {
            PluginLog.Information($"{nameof(P9_召唤_SC)} {text}");

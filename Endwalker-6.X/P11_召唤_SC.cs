...
{
    internal class P11_召唤_SC : SplatoonScript
    {
        public override HashSet<uint> ValidTerritories => new() { 1152 };
        public override Metadata? Metadata => new(3, "P11_召唤_SC");
        ...
        public override void OnUpdate()
        {
            ...
            if (Environment.TickCount64 >= P8_Time)
            {
                Chat.Instance.SendMessage("/scombo set_custom_int_value SMN_PrimalChoice 5");
                myPluginLog($"火风土P8");
        ...
        {
            PluginLog.Information($"{nameof(P11_召唤_SC)} {text}");
